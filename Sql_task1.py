{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<mysql.connector.connection_cext.CMySQLConnection at 0x23b28be0670>"
      ]
     },
     "execution_count": 3,
     "metadata": {},
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "cursor.execute('create table ineurondb.glassdata(col1 INT(10), col2 float(10,5), col3 float(10,5), col4 float(10,5),col5 float(10,5), col6 float(10,5), col7 float(10,5), col8 float(10,5),col9 float(10,5), col10 float(10,5), col11 INT(10))')"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# SHOW ALL TABLES OF THE LOADED DATABASE"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "cursor.execute('select * from ineurondb.glassdata')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "cursor.execute('insert into ineurondb.glassdata values(1,1.52101,13.64,4.49,1.10,71.78,0.06,8.75,0.00,0.00,1)')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "#  READING A CSV FILE AND INSERTING INTO EXISTING TABLE"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "    glass_data = csv.reader(f, delimiter='\\n')\n",
    "    for i in glass_data:\n",
    "        cursor.execute(f'insert into ineurondb.glassdata values({str(i[0])})')\n",
    "\n",
    "mydb.commit()\n",
    "        "
   ]
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "[('col1', b'int', 'YES', '', None, ''),\n",
       " ('col2', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col3', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col4', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col5', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col6', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col7', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col8', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col9', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col10', b'float(10,5)', 'YES', '', None, ''),\n",
       " ('col11', b'int', 'YES', '', None, '')]"
      ]
     },
     "execution_count": 9,
     "metadata": {},
   ...
   "source": [
    "cursor.execute('describe ineurondb.glassdata')\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\Admin\\anaconda3\\lib\\site-packages\\pandas\\io\\sql.py:758: UserWarning: pandas only support SQLAlchemy connectable(engine/connection) ordatabase string URI or sqlite3 DBAPI2 connectionother DBAPI2 objects are not tested, please consider using SQLAlchemy\n",
      "  warnings.warn(\n"
     ]
    },
    {
   ...
   "source": [
    "pd.read_sql('select * from ineurondb.glassdata', mydb)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "cursor.execute('select col1,col5,col10 from ineurondb.glassdata')\n",
    "cursor.fetchall()"
   ]
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Those rows where value of col1 = 3 and col1 = 4"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "cursor.execute('select * from ineurondb.glassdata where col1 = 4')\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "cursor.execute('delete from ineurondb.glassdata where col1=4')\n",
    "mydb.commit()\n"
   ]
  },
  {
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "cursor.execute('UPDATE ineurondb.glassdata SET col1=6, col2=8 where col1=1')\n",
    "mydb.commit()"
   ]
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "[(6, 8.0, 12.79, 3.61, 1.62, 72.97, 0.64, 8.07, 0.0, 0.26, 1)]"
      ]
     },
     "execution_count": 32,
     "metadata": {},
   ...
   "source": [
    "cursor.execute('select * from ineurondb.glassdata where col1=6')\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "cursor.execute('select count(col1), col2  from   ineurondb.glassdata group by col1')\n",
    "cursor.fetchall()"
   ]
  },
  {
   ...
   "source": [
    "cursor.execute('select col1,count(col1), col9 from ineurondb.glassdata group by col1 order by col1')\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Filter a record where col1=11 and col11=2 and show 5 results"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "cursor.execute('select col1,col2,col11 from ineurondb.glassdata where col1=11 or col11=2 limit 5')\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "cursor.execute(\"select * from ineurondb.glassdata where col2 like '%.51%'\")\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "cursor.execute('select * from ineurondb.glassdata order by col2 DESC')\n",
    "cursor.fetchall()"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "cursor.execute(\"select * from (select * from ineurondb.glassdata where col1 > 112) as t where col11=3\")\n",
    "cursor.fetchall()"
   ]
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Having Operation, \"Group by *** Having ***\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "cursor.execute(\"select * from ineurondb.glassdata group by col1 having count(col1) = 2\")\n",
    "cursor.fetchall()"
   ]
  },
  {
   ...
   "source": [
    "cursor.execute(\"select * from ineurondb.glassdata where col1=1\")\n",
    "cursor.fetchall()"
   ]
  },
  {
   ...
   "outputs": [
    {
     ...
     "traceback": [
      ...
      "\u001b[1;32m~\\AppData\\Local\\Temp/ipykernel_36804/1893081180.py\u001b[0m in \u001b[0;36m<module>\u001b[1;34m\u001b[0m\n\u001b[1;32m----> 1\u001b[1;33m \u001b[0mcursor\u001b[0m\u001b[1;33m.\u001b[0m\u001b[0mexecute\u001b[0m\u001b[1;33m(\u001b[0m\u001b[1;34m\"drop table ineurondb.cardata\"\u001b[0m\u001b[1;33m)\u001b[0m\u001b[1;33m\u001b[0m\u001b[1;33m\u001b[0m\u001b[0m\n\u001b[0m\u001b[0;32m      2\u001b[0m \u001b[0mmydb\u001b[0m\u001b[1;33m.\u001b[0m\u001b[0mcommit\u001b[0m\u001b[1;33m(\u001b[0m\u001b[1;33m)\u001b[0m\u001b[1;33m\u001b[0m\u001b[1;33m\u001b[0m\u001b[0m\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# CHECK MISSING VALUES USING PANDA"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "########## ADDING A COLUMN\n",
    "cursor.execute('alter table ineurondb.cardata add class char(20)')\n",
    "mydb.commit()"
   ]
  },
  {
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Using Pandas to Read CSV, Then Copy into Existing Table"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "                  \"VALUES('%s','%s','%s','%s','%s','%s','%s')\" %tuple(testlist))"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "[('buying', b'varchar(20)', 'YES', '', None, ''),\n",
       " ('maint', b'varchar(20)', 'YES', '', None, ''),\n",
       " ('doors', b'varchar(20)', 'YES', '', None, ''),\n",
       " ('person', b'varchar(20)', 'YES', '', None, ''),\n",
       " ('lug_boot', b'varchar(20)', 'YES', '', None, ''),\n",
       " ('safety', b'varchar(20)', 'YES', '', None, ''),\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "### checking if all data is present in table\n",
    "\n",
